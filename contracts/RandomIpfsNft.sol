...
contract RandomIpfsNft is ERC721URIStorage, VRFConsumerBaseV2, Ownable {
    ...
    function getChanceArray() public pure returns (uint256[4] memory) {
        return [4, 15, 50, MAX_CHANCE_VALUE];
    }

    //function called on constructor that sets the tokenURIS
    function _initializeContract(string[4] memory catTokenUris) private {
        if (s_initialized) {
